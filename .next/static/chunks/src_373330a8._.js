(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_373330a8._.js", {
...
function StaffManagementPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StaffManagementPage.useEffect": ()=>{
            const loadStaffMembers = {
                "StaffManagementPage.useEffect.loadStaffMembers": async ()=>{
                    try {
            ...
            }["StaffManagementPage.useEffect.loadStaffMembers"];
            loadStaffMembers();
        }
    }["StaffManagementPage.useEffect"], [
        toast
    ...
    const toggleStaffStatus = (id)=>{
        setStaffMembers(staffMembers.map((staff)=>staff.id === id ? {
                ...staff,
    ...
    const toggleAccountLock = (id)=>{
        setStaffMembers(staffMembers.map((staff)=>staff.id === id ? {
                ...staff,
                accountNonLocked: !staff.accountNonLocked
            } : staff));
        toast({
            title: "Success",
    ...
    const columns = [
        ...
        },
        {
            ...
            header: "Account",
            cell: ({ row })=>{
                const accountNonLocked = row.getValue("accountNonLocked");
...
//# sourceMappingURL=src_373330a8._.js.map