(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_adf09a85._.js", {
...
function StaffDetailsModal({ isOpen, onClose, staff }) {
    ...
    const [enabled, setEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(staff.enabled);
    const [roles, setRoles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(staff.roles);
    const handleSaveChanges = async ()=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axiosConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/manage/update-staff/${staff.id}`, body, {
                headers: {
    ...
    const handleAddRole = ()=>{
        ...
        if (roles.find((r)=>r.name === newRole.trim().toUpperCase())) {
            toast({
                title: "Warning",
                description: "That role already exists on this staff"
            });
            return;
        }
        setRoles((prev)=>[
...
_s(StaffDetailsModal, "MeFZczPVTzSgoSGkzXXhDuoWocA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
function StaffManagementPage() {
    ...
    // For the "Edit" button, we can reuse the same details modal. The user can then click "Save" inside that modal.
    ...
    // Delete the staff from the server
    ...
    const toggleStaffStatusLocally = (id)=>{
        // toggles local state, but real update done in StaffDetails or handleUpdateStaff
        setStaffMembers((prev)=>prev.map((staff)=>staff.id === id ? {
                    ...staff,
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            variant: "outline",
                            size: "sm",
                            onClick: ()=>toggleStaffStatusLocally(id),
...
_s(StaffManagementPage, "fjovZmeH5gGEyR1bPL61PgQ7sY4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
//# sourceMappingURL=src_adf09a85._.js.map