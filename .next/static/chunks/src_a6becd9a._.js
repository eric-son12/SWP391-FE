(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_a6becd9a._.js", {
    ...
    const filteredUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RegisterVaccinationModal.useMemo[filteredUsers]": ()=>{
            return allUsers?.filter({
                "RegisterVaccinationModal.useMemo[filteredUsers]": (user)=>user.fullname.toLowerCase().includes(searchTerm.toLowerCase()) || user.id.toString().includes(searchTerm)
            }["RegisterVaccinationModal.useMemo[filteredUsers]"]) || [];
        }
    }["RegisterVaccinationModal.useMemo[filteredUsers]"], [
        allUsers,
...
_s(RegisterVaccinationModal, "3mdxRLX4Onf/XR+KiU7TKICEOk4=", false, function() {
    return [
...
_s(OrdersPage, "2euWJgQwF0oMeUO9z7ClbCaKyTo=", false, function() {
    return [
...
//# sourceMappingURL=src_a6becd9a._.js.map