...
(()=>{
    const e = new Error("Cannot find module '@/store/auth-store'");
...
(()=>{
    const e = new Error("Cannot find module '@/components/modals/staff-details-modal'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
;
;
// Mock API function to fetch staff members
    ...
    return [
        {
            ...
            phone: "+1234567890",
            bod: "1985-05-15T00:00:00.000Z",
            gender: "Male",
            height: 175,
            weight: 70,
            enabled: true,
            verificationcode: "",
            verficationexpiration: "",
            roles: [
                {
                    name: "ROLE_ADMIN",
...
function StaffManagementPage() {
    ...
    const handleEditStaff = (id)=>{
        // Here you would typically set the staff to edit in your store
        // and then open the edit modal
        const staff = staffMembers.find((s)=>s.id === id);
        if (staff) {
            // Store the staff to edit
            openModal("editStaff");
        }
    };
    ...
    const handleDelete = async ()=>{
        ...
        try {
            // Here you would typically call your API to delete the staff member
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(StaffDetailsModal, {
...
//# sourceMappingURL=src_30c65bf6._.js.map